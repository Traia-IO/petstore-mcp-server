...
# Script to build and run the Petstore MCP Server locally in Docker
...
IMAGE_NAME="petstore-mcp-server"
CONTAINER_NAME="petstore-mcp-local"
HOST_PORT=${PORT:-8000}
CONTAINER_PORT=${PORT:-8000}

echo -e "${BLUE}🚀 Building and running Petstore MCP Server...${NC}"
echo
...
echo
echo -e "${GREEN}✅ Petstore MCP Server is running!${NC}"
echo
